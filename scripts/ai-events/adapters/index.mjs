...
import { HuodongxingAdapter } from './huodongxing.mjs';
...
export function createAdapter(source = {}) {
  ...
  if (source.source_type === 'huodongxing_city') return new HuodongxingAdapter(source);
  ...
  if (url.includes('huodongxing.com')) return new HuodongxingAdapter(source);
