...
export const learningTracks = [
  {
    ...
    summary: "围绕 Codex、Claude Code、Antigravity、Cursor 等 AI 工具，系统化学习 FDE 交付能力。",
    summaryEn: "Systematically learn FDE delivery around AI tools such as Codex, Claude Code, Antigravity, and Cursor.",
  },
  {
    href: "/learn",
    mark: "FDE",
  ...
  },
  {
    ...
    mark: "DATA",
    zh: "AI 工具数据处理",
    en: "AI-Assisted Data Handling",
    summary: "用 AI 工具处理 Excel、CSV、飞书表格和 ERP 导出，生成字段字典、清洗脚本和数据说明。",
    summaryEn: "Use AI tools to handle Excel, CSV, Feishu tables, and ERP exports, producing field dictionaries, cleaning scripts, and data notes.",
  },
  {
    href: "/learn/cloud-deployment",
    mark: "CLOUD",
    zh: "AI 工具部署运行",
    en: "AI-Assisted Deployment",
    summary: "用 AI 工具协助部署、看日志、解释报错、检查环境变量、写上线说明和回滚步骤。",
    summaryEn: "Use AI tools to deploy, inspect logs, explain errors, check env vars, and write launch and rollback notes.",
  },
  {
    ...
    zh: "AI 工具工作流基础",
    en: "AI Tool Workflow",
    summary: "理解 HTML、CSS、React、Git、Vite 的基本概念，是为了更好地指挥 AI 工具修改和验证项目。",
    summaryEn: "Understand basic HTML, CSS, React, Git, and Vite concepts to better direct AI tools for edits and verification.",
  },
  {
    ...
    summary: "把业务需求写成 AI 工具能执行的任务卡、上下文、Prompt 和验收标准。",
    summaryEn: "Turn business needs into task briefs, context, prompts, and acceptance checks that AI tools can execute.",
  },
  {
    ...
    zh: "Agent Workflow",
    en: "Agent Workflow",
    summary: "理解工具调用、状态、人审和安全边界，用 AI 工具画流程、写 Demo、补测试。",
    summaryEn: "Understand tool calls, state, human review, and safety boundaries; use AI tools to map flows, build demos, and add tests.",
  },
  {
    ...
    summary: "用 AI 工具整理测试样本、比较输出、检查工具轨迹，并形成上线验收报告。",
  ...
  },
  {
    ...
    zh: "Soft Stack",
    en: "Soft Stack",
    summary: "在使用 AI 工具之前先判断问题、边界、代价、维护人和客户共识。",
    summaryEn: "Before using AI tools, judge the problem, boundary, cost, owner, and stakeholder alignment.",
  },
  {
    href: "/industries",
    mark: "IND",
