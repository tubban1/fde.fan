...
export default function GenericLoader({ className = '' }: { className?: string }) {
  return (
    <div className={`flex items-center justify-center w-full h-full min-h-[150px] ${className}`}>
      <style>{`
        ...
        .generic-loader-svg path {
          animation-duration: 1s;
          animation-name: customPulse;
          animation-iteration-count: infinite;
          fill: #40c456;
        }
        .generic-loader-svg .path-7 { animation-delay: -1s; }
        .generic-loader-svg .path-6 { animation-delay: -0.875s; }
        .generic-loader-svg .path-5 { animation-delay: -0.75s; }
        .generic-loader-svg .path-4 { animation-delay: -0.625s; }
        .generic-loader-svg .path-3 { animation-delay: -0.5s; }
        .generic-loader-svg .path-2 { animation-delay: -0.375s; }
        .generic-loader-svg .path-1 { animation-delay: -0.25s; }
        .generic-loader-svg .path-0 { animation-delay: -0.125s; }
      `}</style>
      <svg className="generic-loader-svg w-24 h-24" viewBox="0 0 164.83 151.5" xmlns="http://www.w3.org/2000/svg">
